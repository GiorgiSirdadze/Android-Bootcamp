...
import com.example.challenge.presentation.event.conection.ConnectionUiEvent
import com.example.challenge.presentation.event.log_in.LogInEvent
import com.example.challenge.presentation.mapper.connection.toPresentation
                ...
                when (resource) {
                    ...
                    is Resource.Success -> {
                        _connectionState.update { currentState ->
                            currentState.copy(
                                connections = resource.data.toPresentation()
                            )
                        }
                    }
