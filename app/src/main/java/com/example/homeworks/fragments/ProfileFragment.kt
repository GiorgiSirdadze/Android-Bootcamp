...
class ProfileFragment : BaseFragment<FragmentProfileBinding>(FragmentProfileBinding::inflate) {
    ...
    /**
     * Fetches data from API (if needed) and observes paginated data from Room.
     */
    ...
    /**
     * Sets up RecyclerView with Paging Adapter.
     */
    ...
    /**
     * Observes paginated user data from Room and submits it to the adapter.
     */
